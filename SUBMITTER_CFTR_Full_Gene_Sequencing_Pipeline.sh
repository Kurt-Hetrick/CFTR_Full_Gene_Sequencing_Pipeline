	...
	########################################################################
		...
		RUN_BWA ()
		{
			...
			-N A.01-BWA"_"$SGE_SM_TAG"_"$FCID"_"$LANE"_"$INDEX \
				-o $CORE_PATH/$PROJECT/$SM_TAG/LOGS/$SM_TAG"_"$FCID"_"$LANE"_"$INDEX"-BWA.log" \
...
# 				-o $CORE_PATH/$PROJECT/$SM_TAG/LOGS/$SM_TAG"-COLLECT_HS_METRICS.log" \
# 			-hold_jid G.01-INDEX_CRAM"_"$SGE_SM_TAG"_"$PROJECT,C.01-FIX_BED_FILES"_"$SGE_SM_TAG"_"$PROJECT \
...
# 				-o $CORE_PATH/$PROJECT/$SM_TAG/LOGS/$SM_TAG"-SELECT_VERIFYBAMID_VCF.log" \
...
# 				-o $CORE_PATH/$PROJECT/$SM_TAG/LOGS/$SM_TAG"-BGZIP_ANNOTATED_PER_BASE.log" \
# 			-hold_jid H.05-A.02_ANNOTATE_PER_BASE"_"$SGE_SM_TAG"_"$PROJECT \
...
# 				-o $CORE_PATH/$PROJECT/$SM_TAG/LOGS/$SM_TAG"-HC_BAM_TO_CRAM.log" \
...
# 				-o $CORE_PATH/$PROJECT/$SM_TAG/LOGS/$SM_TAG"-HC_INDEX_CRAM.log" \
